...
include('rssgenerator.class.php');
include('atomgenerator.class.php');
/**
 * Klasa FeedGenerator
 * 
 * Creates feed
...
class FeedGenerator {
	 ...
	 */
    public function setGenerator(GeneratorLBC $generator){
    ...
    public function generate(){
    	if(!$this->_generator instanceof GeneratorLBC) throw new FeedGeneratorException('There has been no generator strategy set.');
